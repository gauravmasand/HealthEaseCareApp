import 'package:health_care_app/core/utils/data.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  onTapLogin(BuildContext context) {
    ...
    if (emailController.text.isEmpty || passwordController.text.isEmpty) {
      VxToast.show(context, msg: "Fields are empty");
    } else {
      if (emailController.text == "clint@gmail.com" && passwordController.text == "12345678") {
        Data.flag = false;
        Navigator.popUntil(
            context, (route) => route.isFirst);
        Navigator.pushReplacementNamed(context, AppRoutes.homeContainerScreen);
      } else if (emailController.text == "doctor@gmail.com" && passwordController.text == "12345678") {
        Data.flag = true;
        Navigator.popUntil(
            context, (route) => route.isFirst);
        Navigator.pushReplacementNamed(context, AppRoutes.homeContainerScreen);
      } else {
        VxToast.show(context, msg: "Invalid login credentials");
      }
    }
  }
