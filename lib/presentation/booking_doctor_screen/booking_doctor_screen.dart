...
class BookingDoctorScreen extends StatelessWidget {
  const BookingDoctorScreen({Key? key})
      : super(
          key: key,
        );
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  children: [
                    CustomIconButton(
                      ...
                      decoration:
                          IconButtonStyleHelper.fillOnErrorContainerTL18,
              ...
              _buildTotal(
                context,
                totalText: "Consultation",
                priceText: "60.00",
              ),
              SizedBox(height: 11.v),
              _buildAdminFee(
                context,
                adminFeeText: "Admin Fee",
                priceText: "01.00",
              ),
              SizedBox(height: 11.v),
              _buildAdminFee(
                context,
                adminFeeText: "Aditional Discount",
                priceText: "-",
              ),
